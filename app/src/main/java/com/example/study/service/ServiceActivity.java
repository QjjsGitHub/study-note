...
public class ServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityServiceBinding binding = ActivityServiceBinding.inflate(getLayoutInflater());
        ...
        binding.button13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(ServiceActivity.TAG, "Thread:" + Thread.currentThread().getName() + "  state :onClick startService ");
    ...
    private final ServiceConnection myAidlServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            Log.d(ServiceActivity.TAG, "Thread:" + Thread.currentThread().getName() + "  state :onServiceConnected ");
            try {
                ...
                Log.d(ServiceActivity.TAG, "Thread:" + Thread.currentThread().getName() + "  state :savePeople ");
                iMyAidlInterface.savePeople(bundle);
        ...
        public void onServiceDisconnected(ComponentName name) {
            Log.d(ServiceActivity.TAG, "Thread:" + Thread.currentThread().getName() + "  state :onServiceDisconnected ");
            iMyAidlInterface = null;
        }
    };
